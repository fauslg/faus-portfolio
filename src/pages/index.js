...
export default () => (
    ...
    <div class="experience-case-studies">
      ...
      <div class="logo-wrapper"><img src={ApexLogo} alt="Apex Logo" class="card-logo"/></div>
      <Button buttonText="Design System" />
      </div>
      <div class="card green-gradient">
      <div class="logo-wrapper"><img src={UniversalLogo} alt="Universal Logo" class="card-logo"/></div>
